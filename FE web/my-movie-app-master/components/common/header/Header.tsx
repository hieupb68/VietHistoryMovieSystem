...
const Header = () => {
  ...
  const displayTypes = [
    { id: 1, name: "Chiến Tranh và Cách Mạng" },
    { id: 2, name: "Nhân Vật Lịch Sử" },
    { id: 3, name: "Dã Sử và Truyền Thuyết" },
    { id: 4, name: "Đời Sống Xã Hội trong Quá Khứ" },
    { id: 5, name: "Tư Liệu Lịch Sử" },
  ];
